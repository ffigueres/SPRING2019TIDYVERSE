...
**Tidyverse, Part II, added by Fernando Figueres.**
# As tibble coercion methods

The `as_tibble` function allows R to corce objects such as object, such as a data frame, list, or matrices into tibbles. The output will be a dataframe of type `tbl_df`.
